...
$sql = "SELECT Product_Name,Price,Photo,Category FROM Products WHERE ID = $ID ";

$result = mysqli_query($conn, $sql);
$row=mysqli_fetch_array($result);

// $qwery = "SELECT Category_Name FROM categories WHERE ID = echo $row['Category']";

// $res = mysqli_query($conn, $query);
// $row1=mysqli_fetch_array($res);

// var_dump($row1);die('ddd');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	// 	$productNameError = "Product Name Field is required";
	// } else {
	// 	$productName = test_input($_POST["ProductName"]);
	// }
	// if (empty($_POST["productPrice"])) {
	// 	$productPriceError = "Product Price Field is required";
	// } else {
	// 	$productPrice = test_input($_POST["productPrice"]);
	// }
	// if (empty($_POST["image"])) {
	// 	$productImageError = "Please upload product image";
	// } else {
	// 	$productImage = test_input($_POST["image"]);
	// }
	// if (empty($_POST["productCategory"])) {
	// 	$productCategoryError = "Category Field is required";
	// } else {
    ...
    $folder = "/var/www/html/phpProject/images_upload/" . $filename;
	...
	if ($result && !(empty($_POST["ProductName"]))) {
		...
		<div class="section content_section">
			<div class="container">
				<div class="filable_form_container">
					<form action="UpdateProduct.php" method="post" class="form_container_block" id="form">
						<ul>
							<input type="hidden" name="id" value="<?php echo $ID; ?>">
							<li class="fileds">
								<div class="name_fileds">
									<label>Product Name</label>
									<input name="ProductName" type="text" value="<?php echo $row['Product_Name']; ?>"  />
									<span class="error"><?php echo $productNameError; ?></span>
								</div>
							</li>
							<li class="fileds">
								<div class="name_fileds">
									<label>Product Price</label>
									<input name="productPrice" type="text" value="<?php echo $row['Price']; ?>"/>
									<span class="error"><?php echo $productPriceError; ?></span>
								</div>
							</li>
							<li class="fileds">
								<div class="upload_fileds">
									...
									<input id="uploadFile" name="image" type="file" value=""/>
									<?php echo $row['Photo']; ?>
									<span class="error"><?php echo $productImageError; ?></span>
							...
							<li class="fileds">
								<div class="name_fileds">
									...
									<select name="productCategory" class="select category">
									...
									<span class="error"><?php echo $productCategoryError; ?></span>
								</div>
							</li>
						</ul>
						<div class="next_btn_block">
							...
							<div>
								<button class="button" type="submit" name="submit"><a href="MainProduct.php">Products</a></button>
							</div>
					</form>
				</div>
			</div>
