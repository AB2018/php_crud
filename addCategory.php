...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (empty($_POST["categoryName"])) {
        $categoryNameError = "Category Field is required";
    } else {
        $categoryName = test_input($_POST["categoryName"]);
    }

    $query = "INSERT INTO categories(Category_Name,Created_Date,Updated_Date)VALUES( '$categoryName',NOW(),NULL)";
    $result = mysqli_query($conn, $query);
   

    if ($result && !(empty($_POST["categoryName"]))) {
        ...
        <div class="section content_section">
            <div class="container">
                <div class="filable_form_container">
                    <form action="" method="post" class="form_container_block" id="form">
