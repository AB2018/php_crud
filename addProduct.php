...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$query = "INSERT INTO Products(Product_Name,Price,Photo,Category)VALUES( '$productName','$productPrice','$filename',(SELECT ID FROM categories WHERE Category_Name ='$productCategory'))";
		...
		<div class="section content_section">
			<div class="container">
				<div class="filable_form_container">
					<form action="" method="post" class="form_container_block" id="form" enctype="multipart/form-data">
						<ul>
							<li class="fileds">
								<div class="name_fileds">
									<label>Product Name</label>
									<input name="ProductName" type="text" class="error" />
					  ...
					  <ul>
                            ...
                            <li><a href="MainProduct.php">Back</a></li>
