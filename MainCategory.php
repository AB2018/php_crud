...
$query = "SELECT ID, Category_Name, Created_Date, Updated_Date FROM categories";
...
$result = mysqli_query($conn, "SELECT * FROM categories LIMIT $start_from, $limit");
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="section content_section">
            <div class="container">
                <form class="filable_form_container">
				 ...
				 <div class="Search">
				 	...
				 	<input type="submit" class="submit" value="submit">
                            ...
                            <li><a href="MainProduct.php">Products</a></li>
                            <li><a href="addCategory.php">Add Category</a></li>
                            <li><a id="delete_multiple_category"  href="JavaScript:void(0);">Delete</a></li>
                        </ul>
                    </div>
                        ...
                        <table width="100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td width="10%">
                                            <input type="checkbox" class="user_checkbox1" data-id1="<?php echo $data["ID"]; ?>" />
                                            </td>
                                            ...
                                            <td>
                                                  <a class="btn btn_delete" href="editCategory.php?ID=<?php echo $data['ID'] ?? ''; ?>"></a>
											<a class="btn btn_edit" href="deleteCategory.php?ID=<?php echo $data['ID'] ?? ''; ?> " onclick="return confirm('Are you sure to delete?')"> </a>
                                         </td>
                                        </tr>
                   ...
                   <div class="pagination_listing">
						...
						$result_db = mysqli_query($conn, "SELECT COUNT(ID) FROM categories");
						...
						for ($i = 1; $i <= $total_pages; $i++) {
							$pagLink .= "<li><a href='MainCategory.php?page=" . $i . "'>" . $i . "</a></li>";
						}
						echo $pagLink . "</ul>";
						?>
					</div>
